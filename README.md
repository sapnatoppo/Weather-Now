...
Welcome to the Weather Now repository! This project is a web application that provides real-time weather updates for any location. It utilizes HTML, CSS and JavaScript to deliver a user-friendly interface and fetches data using the OpenWeatherMap API.
...
```sh
 git clone https://github.com/sapnatoppo/weather-now.git
```
